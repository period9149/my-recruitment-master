...
$template['title']='具体职业添加';
$template['css']=array('style/public.css');
?>
<?php include 'inc/header.inc.php'?>
<div id="main">
	<div class="title" style="margin-bottom:20px;">添加具体职业</div>
	<form method="post">
		<table class="au">
			<tr>
				<td>所属职业类别</td>
				<td>
					<select name="father_module_id">
						<option value="0">请选择一个职业类别</option>
						<?php 
