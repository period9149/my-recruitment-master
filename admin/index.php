...
<div id="main">
	...
	<div class="explain">
		<ul>
			<li>|- 职业类别(<?php echo $count_father_module?>)
			                 具体职业(<?php echo $count_son_module?>)
	...
	<div class="explain">
		<ul>
			...
			<li>|- 程序版本：zpxt V1.0 <a target="_blank" href="http://www.sifangku.com">[查看最新版本]</a></li>
			<li>|- 程序作者：俞行舟</li>
			<li>|- 网站：<a target="_blank" href="http://www.zpxt.com">www.zpxt0.com</a></li>
		</ul>
	</div>
</div>
