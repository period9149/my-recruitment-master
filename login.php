...
<?php include 'inc/header.inc.php'?>
	<div id="register" class="auto">
		...
		<form method="post">
			...
			<label>用户种类：
				<select style="width:546px;height:25px;" name="text">
					<option $Member['mark']="1">普通用户</option>
					<option $Member['mark']="0">企业用户</option>
				</select>
			</label>
