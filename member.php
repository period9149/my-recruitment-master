	...
	<div id="right">
		<div class="member_big">
			<dl>
			   ...
			   <dd><a target="_blank" href="member_photo_update.php">修改头像<br></a><!--  | <a target="_blank" href="">修改密码</a></dd> -->
				...
				<br>
					...
					<dt>
					<img width="180" height="180" src="<?php if($data_member['jianli']!=''){echo SUB_URL.$data_member['jianli'];}else{echo 'null';}?>" />
				</dt>
				<br>
				<dd><a target="_blank" href="member_jianli_update.php">查看/修改简历</a><!--  | <a target="_blank" href="">修改密码</a></dd> -->
				<?php }?>
			</dl>
			<div style="clear:both;"></div>
		</div>
